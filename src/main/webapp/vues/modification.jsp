...
<!-- La colonne quantité possède un input pour pouvoir modifier les différentes quantités  -->

<!-- La variable "status" qui permet de nommer les champs du formulaire et de filtrer les messages d'erreurs selon l'occurence 
